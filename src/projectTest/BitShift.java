...
public class BitShift {
   ...
   */
   private void initialize() {
      ...
      btnClear.setFont(new Font("맑은 고딕", Font.PLAIN, 20));
      ...
      lblNewLabel_1 = new JLabel("찾고 싶은 비트의 위치");
      lblNewLabel_1.setBounds(27, 72, 140, 15);
      panel.add(lblNewLabel_1);
      
      lblNewLabel_2 = new JLabel(">> 이동할 비트 수");
      lblNewLabel_2.setBounds(266, 4, 146, 15);
      panel.add(lblNewLabel_2);
      
      lblNewLabel_3 = new JLabel("<< 이동할 비트 수");
      lblNewLabel_3.setBounds(262, 73, 107, 15);
